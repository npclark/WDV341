...
<body>
<h1>Intro to PHP</h1>
<h2>Assignment 7-2 selectOneEvent</h2>
<?php
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT id, name, description, presenter, date, time, date_inserted, date_updated FROM wdv341_events WHERE id=2");
        $stmt->execute();
